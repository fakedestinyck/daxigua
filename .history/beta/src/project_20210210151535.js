                        ...
                        return (
                            ...
                            (t.prototype.update = function (e) {
                                if (
                                    ...
                                    for (var t = 0; t < 3; t++)
                                        this.node.children[t].removeComponent(
                                            cc.BoxCollider
                                        );
                                    a.default.Despawn(
                                        this.node.name,
                    ...
                    f = (function (e) {
                        ...
                        return (
                            ...
                            (t.prototype.MilkEffect = function (e, t) {
                                var n = i.default.Spawn(
                                    "milk",
                                    this.downEffectPartiParent
                                );
                            ...
                            (t.prototype.SendGoldCoin = function (e, t, n) {
                                ...
                                o = e;
                                for (
                                    var c = a.default.ConvertPosition(
                                            t,
                                            this.uiEffectParent
                                        ),
                                        r = a.default
                            ...
                            (t.prototype.PutEFF = function (e, t) {
                                for (
                                    ...
                                    s.Reset();
                                    var l = r.default.Instance.GetSpriteFrame(
                                        "ball"
                                    );
                            ...
                            (t.prototype.PortDownEff = function (e) {
                                for (
                                    ...
                                    o.Reset(),
                                        ...
                                        (o.node.opacity = a.default.RandomInteger(
                                            120,
                                            250
                                        )),
                            ...
                            (t.prototype.LittleFly = function (e) {
                                for (
                                    ...
                                    c.SetId(a.default.RandomInteger(1, 5)),
                                        ...
                                        (c.mosquitoSpeedLen = a.default.RandomInteger(
                                            6,
                                            12
                                        )),
                                        (c.mosquitoSpeedMaxR = a.default.RandomInteger(
                                            6,
                                            12
                                        )),
                                        c.startFun();
                            ...
                            (t.prototype.createBlood = function (e) {
                                for (var t = 0; t < 3; t++) {
                                    ...
                                    o.Reset(),
                                        ...
                                        (o.node.color = new cc.Color().fromHEX(
                                            "#AD0909"
                                        )),
                                        n.setContentSize(
                            ...
                            (t.prototype.LightBoomAndMove = function (e, t) {
                                for (
                                    ...
                                    var d =
                                        a.default.Random(0, 100) < 50 ? 1 : -1;
                                    c.runAction(
                                        cc.sequence(
                                            cc.delayTime(u),
                                            cc.rotateBy(
                                                l,
                                                a.default.Random(180, 200) * d
                                            )
                                        )
                                    );
                                }
                            ...
                            (t.prototype.ShowFailedUi = function (e, t) {
                                ...
                                this.scheduleOnce(function () {
                                    r.default.Instance.HideScorePanel(),
                                        ...
                                        (n.highScoreLabel.string = "0"),
                                        (n.resultTxt.string = n.GetContentByScore(
                                            e
                                        )),
                                        (n.overTxt.string =
                                            "\u5f53\u524d\u5173\u5361\u5df2\u5b8c\u6210" +
                    ...
                    m = (function (e) {
                        ...
                        return (
                                    ...
                                    cc.tween(t)
                                        .to(
                                            0.8, {
                                                ...
                                                opacity: s.default.getRandomNum(
                                                    0.4,
                                                    0.8
                                                ),
                                            }, {
                            ...
                            (t.prototype.calculateScore = function (e) {
                                return window.GAMESETTINGS.calculateScoreFunction(
                                    e
                                );
                            }),
                            (t.prototype.ShowLandParti = function (e, t) {
                    ...
                    (l.property,
                        (function (e) {
                            ...
                            return (
                                ...
                                (t.prototype.PhysicsSystemCtrl = function (
                                    e,
                                    t
                                ) {
            ...
            function (e, t, n) {
                ...
                var o = {
                    ...
                    scheduleOnce: function (e, t, n) {
                        e.runAction(
                            cc.sequence(cc.delayTime(n), cc.callFunc(t, e))
                        );
                    },
                ...
                var a = e("./GameFunction"),
                    ...
                    p = (function (e) {
                        ...
                        return (
                            ...
                            (t.prototype.start = function () {
                                this.openTouch(),
                                    (this.RockerJS = this.Rocker.getComponent(
                                        "Rocker"
                                    ));
                            }),
                            (t.prototype.update = function (e) {}),
                                            ...
                                            i.default.GameUpdateCtrl && 
                                                (0 == t.createFruitCount ?
                                                    ...
                                                    (a.default.Instance.createOneFruit(
                                                            ...
                                                            window.difficulty[s.default.RandomInteger(0,6)]
                                                            :
                                                            s.default.RandomInteger(
                                                                window.difficulty[0],
                                                                window.difficulty[1] +
                    ...
                    u = (function (e) {
                        ...
                        return (
                            ...
                            (t.prototype.SetId = function (e) {
                                e < 1 && (e = 1), e > 4 && (e = 4);
                                var t = a.default.Instance.GetSpriteFrame(
                                        "littleWing" + e
                                    ),
                                    n = a.default.Instance.GetSpriteFrame(
                                        "littleBody" + e
                                    );
                            ...
                            (t.prototype.getPointByCPAndAngleAndLen = function (
                                e,
                                t,
                                n
                            ) {
                        ...
                        return (
                            ...
                            (t.prototype.resetWater = function () {
                                ...
                                this.unschedule(this.scheduleWater),
                                    this.waterParent.children.forEach(function (
                                        t
                                    ) {
                    ...
                    stop: function () {
                        this.target.setPosition(
                            this.target.position.add(
                                cc.v2(-this.xOffset, -this.yOffset)
                            )
                        );
                    },
                });
                        ...
                        return (
                            ...
                            (t.prototype.onLoad = function () {
                                ...
                                for (
                                    ...
                                    this.spriteFrameMap.set(
                                        o[0],
                                        this.allSpriteFrame[e]
                                    );
                                }
                            }),
            ...
            function (e, t, n) {
                ...
                var o = {
                    ...
                    newSprite: function (e) {
                        if (null != this.SpriteFrameJs.getSpriteFrame(e)) {
                            ...
                            return (
                                (t.addComponent(
                                    cc.Sprite
                                ).spriteFrame = this.SpriteFrameJs.getSpriteFrame(
                                    e
                                )),
                                t
                            );
                    ...
                    delayTimeCall: function (e, t, n, o) {
                        e.runAction(
                            cc.sequence(cc.delayTime(n), cc.callFunc(t, o))
                        );
                    },
            ...
            function (e, t, n) {
                ...
                var o = (function () {
                    ...
                    return (
                        ...
                        (e.judgeItemOverlapping = function (
                            e,
                            t,
                            n,
                            o,
                                                ...
                                                .call(function () {
                                                    i.default.Instance.createFruitSui(
                                                        ...
                                                        i.default.Instance.createLevelUpFruit(
                                                            ...
                                                            window
                                                            .GAMESETTINGS
                                                            .startFruit : window.eventVersion != 7 ?
                                                            o.fruitNumber +
                                                            window
                                                            .GAMESETTINGS
                                                            .levelUpWayIncrease *
                        ...
                        return (
                            ...
                            (t.prototype.shootShell = function () {
                                ...
                                e.runAction(cc.scaleTo(0.2, 0.5)),
                                    ...
                                    e.runAction(
                                        cc.repeatForever(cc.rotateBy(3, 1080))
                                    );
                            }),
                            (t.prototype.onCollisionEnter = function (e, t) {
                                "shell" == e.node.group &&
